  ...
  return (
    <section id="style" className="py-12 md:py-24 px-4 md:px-6 bg-[#0E0E0E] overflow-hidden border-t border-[#4A0404]/30 scroll-mt-32">
      ...
      {selectedVideo && (
        ...
        >
          <div 
            className="relative w-[min(90vw,calc(85svh*9/16))] aspect-[9/16] bg-black rounded-2xl overflow-hidden border-2 border-[#FF5F1F] shadow-[0_0_60px_rgba(255,44,44,0.4)] animate-in zoom-in-95 duration-300 group/player"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header Overlay */}
            <div className="absolute top-4 left-4 right-4 z-50 flex justify-between items-start pointer-events-none">
                <span className="px-3 py-1.5 bg-black/60 backdrop-blur-md border border-white/10 rounded-full text-[#FF5F1F] font-black uppercase text-[10px] tracking-widest">
                  Mastery Showcase
                </span>
                <button 
                  onClick={closeModal}
