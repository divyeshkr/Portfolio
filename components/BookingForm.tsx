    ...
    <section className="py-12 md:py-24 px-6 bg-[#121212] relative border-t border-[#4A0404]/30 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-16 md:mb-20 reveal opacity-0 translate-y-10 transition-all duration-700">
          ...
          {/* Steps - Vertical on Mobile to prevent squishing, Horizontal on Desktop */}
        ...
        {/* The Direct Jump Target - Adjusted scroll margin and bottom padding */}
        <div id="demo-request" className="scroll-mt-24 md:scroll-mt-32 bg-[#1A1A1A] border border-[#4A0404]/40 rounded-[2.5rem] p-8 md:p-16 reveal opacity-0 translate-y-10 transition-all duration-700 shadow-2xl relative overflow-hidden group/form hover:border-[#FF2C2C]/20 transition-all pb-32 md:pb-16">
