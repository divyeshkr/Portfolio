    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-16 px-6 overflow-hidden bg-[#121212]">
      ...
      <div className="z-10 text-center max-w-6xl mx-auto flex flex-col items-center">
        <div className="relative mb-8 md:mb-10 reveal opacity-0 translate-y-10 transition-all duration-700">
          ...
          <div className="w-28 h-28 md:w-44 md:h-44 rounded-full border-2 border-[#FF2C2C] overflow-hidden p-1 shadow-[0_0_40px_rgba(74,4,4,0.6)] bg-[#1F1F1F] flex items-center justify-center">
            {!imgLoaded && (
        ...
        <div className="mt-12 w-full grid grid-cols-3 gap-4 border-y border-white/5 py-8 reveal opacity-0 translate-y-10 transition-all duration-700 delay-600 max-w-4xl bg-gradient-to-r from-transparent via-white/[0.02] to-transparent">
        ...
        <div className="mt-10 max-w-2xl mx-auto p-5 border border-[#4A0404] bg-[#4A0404]/10 rounded-2xl reveal opacity-0 translate-y-10 transition-all duration-700 delay-700">
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-6 reveal opacity-0 translate-y-10 transition-all duration-700 delay-800">
          <a 
            href="#booking" 
            className="group animate-cta-pulse relative inline-flex items-center justify-center px-10 py-5 font-black text-lg text-white uppercase tracking-widest bg-gradient-to-br from-[#FF2C2C] to-[#FF5F1F] overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,44,44,0.3)]"
          >
            <span className="relative">Claim Free Demo Edit</span>
          </a>
          <a 
            href="#work" 
            className="group relative inline-flex items-center justify-center px-10 py-5 font-black text-lg text-white uppercase tracking-widest bg-transparent border-2 border-[#4A0404] overflow-hidden transition-all duration-300 hover:border-[#FF2C2C] hover:text-[#FF2C2C] hover:shadow-[0_0_20px_rgba(74,4,4,0.3)]"
          >
