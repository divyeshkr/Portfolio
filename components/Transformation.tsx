  ...
  return (
    <section className="py-24 px-6 bg-black relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Transformation Display - Two Panels with Arrow */}
        <div className="relative flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 reveal opacity-0 translate-y-10 transition-all duration-700 delay-200">
          ...
          {/* RAW Panel */}
          <div 
            onClick={() => openVideo(CONFIG.transformation.rawVideoUrl)}
            className="group relative w-full lg:w-[350px] aspect-[9/16] bg-[#111] rounded-2xl overflow-hidden border border-white/10 cursor-pointer hover:border-gray-500 transition-all duration-500 shadow-2xl"
          >
            <img 
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&q=80&w=2000&sat=-100&brightness=-20";
              }}
            />
          ...
          <div className="flex flex-col items-center justify-center z-10 lg:rotate-0 rotate-90 py-4 lg:py-0">
            ...
            <span className="mt-4 text-[10px] font-black uppercase tracking-[0.5em] text-[#FF0000] lg:block hidden">Evolution</span>
          </div>

          {/* VIRAL Panel */}
          <div 
            onClick={() => openVideo(CONFIG.transformation.editedVideoUrl)}
            className="group relative w-full lg:w-[350px] aspect-[9/16] bg-[#111] rounded-2xl overflow-hidden border border-[#FF0000]/30 cursor-pointer hover:border-[#FF0000] transition-all duration-500 shadow-[0_0_40px_rgba(255,0,0,0.1)]"
          >
            <img 
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&q=80&w=2000";
              }}
            />
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 reveal opacity-0 translate-y-10 transition-all duration-700 delay-400">
          <div className="p-6 bg-white/5 border-l-4 border-[#FF0000] group hover:bg-[#FF0000]/5 transition-colors">
            ...
            <p className="text-sm text-gray-400">Pushing shadows and highlights to create that professional cinematic depth.</p>
          </div>
          <div className="p-6 bg-white/5 border-l-4 border-[#FF0000] group hover:bg-[#FF0000]/5 transition-colors">
            <h4 className="font-black text-[#FF0000] uppercase mb-2">Sound Design</h4>
            <p className="text-sm text-gray-400">Layering hits, risers, and ambient textures for an immersive audio experience.</p>
          </div>
          <div className="p-6 bg-white/5 border-l-4 border-[#FF0000] group hover:bg-[#FF0000]/5 transition-colors">
            <h4 className="font-black text-[#FF0000] uppercase mb-2">High Impact Pacing</h4>
            <p className="text-sm text-gray-400">Cutting the fluff to ensure every second contributes to the overall hook and retention.</p>
          </div>
        </div>
      </div>
      ...
      {selectedVideo && (
        ...
        >
          ...
          <div className="absolute bottom-10 text-center pointer-events-none">
            <p className="text-[#FF0000] font-black uppercase tracking-[0.5em] text-xs animate-pulse">Evolutionary Analysis</p>
          </div>
        </div>
      )}
    </section>
