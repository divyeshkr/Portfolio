...
const Transformation: React.FC = () => {
  ...
  return (
    <section className="py-24 px-4 md:px-6 bg-[#0E0E0E] relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 reveal opacity-0 translate-y-10 transition-all duration-700 text-center">
          ...
          <p className="text-[#EDEDED]/80 text-sm md:text-lg uppercase tracking-widest font-black italic">Same footage. Different results.</p>
        </div>
        ...
        <div className="relative flex flex-row lg:flex-row items-center justify-center gap-2 md:gap-16 reveal opacity-0 translate-y-10 transition-all duration-700 delay-200">
          ...
          <div className="flex flex-col items-center justify-center z-10 py-2 md:py-0">
            <div className="w-8 h-8 md:w-12 md:h-12 rounded-full border-2 border-[#FF2C2C] flex items-center justify-center animate-pulse shadow-[0_0_20px_rgba(255,44,44,0.4)] bg-black">
              <svg className="w-4 h-4 md:w-6 md:h-6 text-[#FF2C2C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center gap-2 md:gap-4 group w-1/2 lg:w-auto">
            <div 
              ...
              className="relative w-full md:w-[280px] lg:w-[320px] aspect-[9/16] bg-[#1a1a1a] rounded-xl md:rounded-2xl overflow-hidden border-2 border-[#FF2C2C] cursor-pointer hover:shadow-[0_0_60px_rgba(255,44,44,0.2)] transition-all duration-500 shadow-[0_0_40px_rgba(255,44,44,0.1)]"
            >
              <img 
              ...
              />
              <div className="absolute top-2 right-2 md:top-6 md:right-6 bg-[#FF2C2C] px-2 py-1 md:px-4 md:py-2 font-black text-[8px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.3em] rounded shadow-[0_0_15px_rgba(255,44,44,0.5)]">
                The Viral
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-12 h-12 md:w-20 md:h-20 rounded-full bg-[#FF2C2C] flex items-center justify-center shadow-[0_0_40px_rgba(255,44,44,0.6)] group-hover:scale-110 transition-transform">
            ...
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-[#FF2C2C] neon-glow text-center">Hooked & Shared</span>
          </div>
        </div>

        <div className="mt-12 md:mt-20 p-6 md:p-8 border border-[#FF2C2C]/20 bg-[#FF2C2C]/5 rounded-2xl md:rounded-3xl reveal opacity-0 translate-y-10 transition-all duration-700 delay-400 max-w-4xl mx-auto text-center">
            <h4 className="text-[#FF2C2C] font-black uppercase tracking-[0.3em] text-[10px] md:text-xs mb-2 md:mb-4">Retention Engineering</h4>
